...
WebUI.click(findTestObject('Page_Kelola Destinasi - Smart Tourism/button_p-2.5 bg-red-50 text-red-500 rounded-full'))

WebUI.click(findTestObject('Page_Kelola Destinasi - Smart Tourism/button_Hapus Destinasi'))

WebUI.rightClick(findTestObject('Page_Kelola Destinasi - Smart Tourism/div_Destination deleted from MongoDB successfull'))

WebUI.verifyElementVisible(findTestObject('Page_Kelola Destinasi - Smart Tourism/div_Destination deleted from MongoDB successfull'))
