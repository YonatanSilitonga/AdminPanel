...
<header class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
    <div class="flex items-center justify-between h-16 px-6">
        ...
        <div class="flex items-center space-x-4 min-w-0">
            ...
            <button type="button" class="p-2 text-gray-500 hover:text-primary hover:bg-blue-50 rounded-lg transition-colors focus:outline-none flex-shrink-0" aria-label="Toggle Sidebar">
        ...
        <div class="flex items-center space-x-4 sm:space-x-6">
            ...
            <div class="relative" x-data="{ open: false }" x-init="open = false">
                <button @click="open = !open; $event.currentTarget.blur()" class="text-gray-600 hover:text-primary relative p-2 hover:bg-gray-100 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- User Menu -->
            <div class="relative" x-data="{ open: false }" x-init="open = false">
                <button @click="open = !open; $event.currentTarget.blur()" class="flex items-center space-x-2 text-gray-700 hover:text-primary p-2 hover:bg-gray-100 rounded-lg transition-colors">
