...
@if (!app_setting('enable_reports', true))
    <div class="mb-6 p-4 bg-amber-50 border border-amber-200/40 rounded-2xl flex items-start gap-3">
        ...
        <div>
            <p class="text-sm font-bold text-amber-800">Sistem Laporan Dinonaktifkan</p>
            <p class="text-xs text-amber-700 mt-1">Pengunjung tidak dapat melaporkan isu atau masalah pada halaman ulasan di situs publik (frontend).</p>
        </div>
    </div>
@endif
                                        ...
                                        <div class="flex items-center gap-1.5 mt-0.5">
                                            ...
                                            @if($isRegistered)
                                                <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-bold bg-[#E6F6F2] text-[#00A884] uppercase tracking-wide border border-[#00A884]/10">
                                                    <svg class="w-2.5 h-2.5 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                                                    User
                                                </span>
                                            @else
