...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8 mt-2">
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8 hover:shadow-md transition-all duration-300">
        ...
        <div class="space-y-4">
            <!-- Total Ulasan -->
            <div class="flex justify-between items-center p-4 bg-gray-50/50 hover:bg-purple-50/40 rounded-2xl transition-all duration-300 group border border-gray-100/50 hover:border-purple-100 hover:scale-[1.02]">
                <div class="flex items-center">
                    <div class="p-2 bg-purple-50 group-hover:bg-purple-100/80 rounded-xl text-purple-600 transition-colors mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                    </div>
                    <span class="text-sm font-semibold text-gray-600 group-hover:text-purple-900 transition-colors">Total Ulasan</span>
                </div>
                <span class="text-lg font-bold text-gray-900 group-hover:text-purple-700 transition-colors">{{ number_format($stats['total_reviews'] ?? 0) }}</span>
            </div>

            <!-- Jumlah Fasilitas Umum -->
            <div class="flex justify-between items-center p-4 bg-gray-50/50 hover:bg-emerald-50/40 rounded-2xl transition-all duration-300 group border border-gray-100/50 hover:border-emerald-100 hover:scale-[1.02]">
                <div class="flex items-center">
                    <div class="p-2 bg-emerald-50 group-hover:bg-emerald-100/80 rounded-xl text-emerald-600 transition-colors mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                    </div>
                    <span class="text-sm font-semibold text-gray-600 group-hover:text-emerald-900 transition-colors">Fasilitas Umum</span>
                </div>
                <span class="text-lg font-bold text-gray-900 group-hover:text-emerald-700 transition-colors">{{ number_format($stats['total_facilities'] ?? 0) }}</span>
            </div>
        </div>
    </div>
