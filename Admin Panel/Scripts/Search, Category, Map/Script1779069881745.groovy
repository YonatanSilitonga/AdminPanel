...
WebUI.setText(findTestObject('Page_Kelola Destinasi - Smart Tourism/input_edit_latitude'), '2.34772')

WebUI.setText(findTestObject('Page_Kelola Destinasi - Smart Tourism/input_edit_longitude'), '99.070450')
