...
WebUI.click(findTestObject('Page_Toba Tourism - Admin Panel/input_'))

WebUI.doubleClick(findTestObject('Page_Toba Tourism - Admin Panel/input_'))
...
WebUI.setText(findTestObject('Page_Kelola Destinasi - Smart Tourism/input_Festival Danau Toba'), 'Pantai Bul Bul')
...
WebUI.click(findTestObject('Page_Kelola Destinasi - Smart Tourism/div_div'))

WebUI.setText(findTestObject('Page_Kelola Destinasi - Smart Tourism/input_Toko Suvenir, Toilet Umum, Area Parkir'), 'Toilet Umum, Area Parkir')
...
WebUI.rightClick(findTestObject('Page_Kelola Destinasi - Smart Tourism/p_Destination created in MongoDB successfully'))

WebUI.verifyElementVisible(findTestObject('Page_Kelola Destinasi - Smart Tourism/p_Destination created in MongoDB successfully'))
