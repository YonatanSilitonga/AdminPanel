...
WebUI.click(findTestObject('Page_Dashboard Overview - Smart Tourism/svg_w-6 h-6'))

WebUI.click(findTestObject('Page_Dashboard Overview - Smart Tourism/svg_w-4 h-4 text-gray-400'))

WebUI.click(findTestObject('Page_Dashboard Overview - Smart Tourism/a_Kelola Event'))
